...
wall.addEventListener("click", (e)=>{
    ...
    if (x < 0) x = 0;
    else if (x > wallRect.width - spiderRect.width - borderWidth) x = wallRect.width - spiderRect.width - borderWidth;
    if (y < 0) y = 0;
    else if (y > wallRect.height - spiderRect.height - borderWidth) y = wallRect.height - spiderRect.height - borderWidth;
